# Adapted from zimfw/fzf. The generated integration is streamed from the
# nixpkgs-provided fzf executable because Nix store plugin sources are immutable.
(( ${+commands[fzf]} )) || return 1
source <(command fzf --zsh) || return 1
